"""Structured env-layer observation builder with no raw runtime-object leakage."""
...
def build_observation(normalized_state: NormalizedEnvState) -> Observation:
    """Build the first structured Mission 1 observation from a normalized state."""
    ...
    return {
        ...
        "unresolved_markers": [
            {
                "marker_id": marker_state.marker_id,
